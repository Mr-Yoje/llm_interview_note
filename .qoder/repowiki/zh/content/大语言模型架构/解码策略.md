...
## 更新摘要
**所做更改**
- 修正了文档中的LaTeX语法格式问题，统一了数学公式的显示格式
- 统一了温度采样算法描述的格式一致性，提升了专业性
- 改进了数学公式的专业呈现，确保符号和格式规范
- 优化了代码示例的格式和可读性，增强了整体文档质量
...
温度缩放的数学公式为：
$$
P(token_i) \propto \frac{\exp(\text{logit}_i / T)}{\sum_j \exp(\text{logit}_j / T)}
$$
其中T为温度参数。
